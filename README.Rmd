...
of linear, logistic and Cox regression models in multiply imputed data sets 
using Rubin's Rules (RR), the D1, D2, D3, D4 and the median p-values method. 
...
in multiple imputed data sets is available and a function to compare models 
