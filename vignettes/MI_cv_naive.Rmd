...
in the figure (Figure \@ref(fig:micvnaive)) 

```{r micvnaive, echo = FALSE, fig.cap="\\label{fig:micvnaive} Schematic overview of the MI_cv_naive method", out.width='100%', fig.align='center'}
