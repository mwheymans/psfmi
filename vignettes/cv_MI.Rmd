...
on the papers of Mertens BJ (2020) and Miles A (2015). The `cv_MI` method is implemented in the function `psfmi_validate`. An explanation and examples of how to use the method can be found below.
