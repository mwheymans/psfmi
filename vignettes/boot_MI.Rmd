---
title: "Multiple Imputation and Cross-validation - Method boot_MI"
...
How these steps work is visualized in figure (Figure \@ref(fig:bootmi)) 

```{r bootmi, echo = FALSE, fig.cap="\\label{fig:bootmi} Schematic overview of the boot_MI method", out.width='100%', fig.align='center'}
