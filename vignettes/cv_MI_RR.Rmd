...
logistic prediction models. This cross-validation method is based on the papers of Mertens BJ (2020) and Miles A (2015). The `cv_MI_RR` method is implemented in the function `psfmi_validate`. An explanation and examples of how to use the methods can be found below.
