...
This page contains information of the `cv_MI_RR` method that is implemented 
...
How these steps work is visualized in figure (Figure \@ref(fig:cvmirr)) 

```{r cvmirr, echo = FALSE, fig.cap="\\label{fig:cvmirr} Schematic overview of the cv_MI_RR method", out.width='100%', fig.align='center'}
