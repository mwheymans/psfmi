...
#'  can be extracted: ROC results \code{ROC}, R squared results \code{R2}, 
#'  Hosmer and Lemeshow test \code{HL_test}, linear predictor pooled \code{LP_pooled}, 
#'  performance after internal validation \code{Int_val_pooled}, 
